...
SELECT id, seller_id, company_id, campaign_id, data_venda, status, valor_mensal, equipe, tipo_negociacao, plano_contratado, produtos, observacoes_vendedor, motivo_pendencia, razao_social, nome_fantasia, contato_responsavel, created_at, updated_at, bl_valor, vivo_total_valor, movel_valor, endereco_rua, endereco_numero, endereco_bairro, endereco_cidade, endereco_cep, documentos,
